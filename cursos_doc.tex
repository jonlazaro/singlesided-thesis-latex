...
\newcommand{\thesistitle}{Nuevo enfoque para la fusión de Linked Data basado en la evaluación de la calidad de los datos}

%Author name
\newcommand{\authorname}{Jon Lázaro Aduna}

%First advisor name
\newcommand{\advisorname}{Dr. Diego López-de-Ipiña González-de-Artaza}
...
\degree{}
\author{\authorname} 
\collegeordept{jlazaro@deusto.es}
...
\include{1_introduccion/0_index}	
\include{2_revision_bibliografica/0_index}
\include{3_marco_investigacion/0_index}
\include{4_metodologia/0_index}
